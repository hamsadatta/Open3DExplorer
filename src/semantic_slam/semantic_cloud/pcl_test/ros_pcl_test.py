...
class testPclRos:
    ...
    def __init__(self):
        ...
        self.color_sub = message_filters.Subscriber("/hsrb/head_rgbd_sensor/rgb/image_raw",Image, queue_size = 1, buff_size = 24*640*500 )
        self.depth_sub = message_filters.Subscriber("/hsrb/head_rgbd_sensor/depth_registered/image_raw", Image, queue_size = 1, buff_size = 32*640*500 ) # increase buffer size to avoid delay (despite queue_size = 1)
